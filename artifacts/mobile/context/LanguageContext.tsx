...
const translations = {
  ar: {
    ...
    camera: {
      ...
      permissionSubDriver: "لمسح رموز QR لبطاقات الركاب",
      permissionSubDist: "لمسح رموز QR لبطاقات المستخدمين",
      allow: "السماح بالكاميرا",
      orManual: "أو أدخل رقم البطاقة يدوياً",
    },
    support: {
      title: "📞 مراسلة الدعم",
      subtitle: "تواصل مع فريق الدعم الفني للمساعدة",
      whatsapp: "واتساب",
    },
    profileSection: {
      accountInfo: "معلومات الحساب",
      userRole: "مستخدم",
      joinDate: "تاريخ الإنشاء",
      accountStatus: "الحالة",
      activeStatus: "نشط ✓",
      inactiveStatus: "غير نشط",
      darkModeLabel: "الوضع الليلي",
      darkModeOn: "الوضع الداكن مفعّل",
      darkModeOff: "الوضع الفاتح مفعّل",
      language: "🌐 اللغة / Language",
      balanceRequest: "طلب رصيد من المنصة",
      balanceRequestSub: "اطلب رصيداً جديداً عند نفاد رصيدك",
      settings: "الإعدادات",
      changePwdHint: "تغيير كلمة المرور الحالية",
      switchHint: "تسجيل الدخول بحساب آخر",
    },
  },
  fr: {
    ...
    camera: {
      ...
      permissionSubDriver: "Pour scanner les QR des clients passagers",
      permissionSubDist: "Pour scanner les QR des cartes clients",
      allow: "Autoriser la caméra",
      orManual: "Ou saisir le numéro de carte manuellement",
    },
    support: {
      title: "📞 Contacter le support",
      subtitle: "Contactez notre équipe de support technique",
      whatsapp: "WhatsApp",
    },
    profileSection: {
      ...
      balanceRequest: "Demander un solde",
      balanceRequestSub: "Demandez du crédit quand votre solde est épuisé",
      settings: "Paramètres",
      changePwdHint: "Modifier votre mot de passe actuel",
      switchHint: "Se connecter avec un autre compte",
    },
  },
  en: {
    ...
    camera: {
      ...
      permissionSubDriver: "To scan passenger QR codes",
      permissionSubDist: "To scan customer card QR codes",
      allow: "Allow Camera",
      orManual: "Or enter card number manually",
    },
    support: {
    ...
    profileSection: {
      ...
      language: "🌐 Language",
      balanceRequest: "Request Balance from Platform",
      balanceRequestSub: "Request new credit when your balance runs out",
      settings: "Settings",
      changePwdHint: "Change your current password",
      switchHint: "Login with another account",
    },
  },
};
