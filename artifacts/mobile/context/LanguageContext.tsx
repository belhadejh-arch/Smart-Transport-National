...
const translations = {
  ar: {
    ...
    auth: {
      ...
      logoutConfirm: "هل تريد تسجيل الخروج؟ سيتم مسح بيانات الجلسة.",
    ...
    admin: {
      ...
      transactions: "المعاملات", withdrawals: "طلبات السحب", profile: "ملفي",
      ...
      changeEmail: "تغيير البريد الإلكتروني", changePassword: "تغيير كلمة المرور",
      darkMode: "الوضع الليلي", logoutWarning: "سيتم مسح جميع بيانات الجلسة من الجهاز.",
    },
    driver: {
  ...
  fr: {
    ...
    auth: {
      ...
      logoutConfirm: "Voulez-vous vous déconnecter ? Les données de session seront effacées.",
    ...
    admin: {
      ...
      transactions: "Transactions", withdrawals: "Retraits", profile: "Profil",
      ...
      changeEmail: "Changer l'e-mail", changePassword: "Changer le mot de passe",
      darkMode: "Mode sombre", logoutWarning: "Toutes les données de session seront effacées.",
    },
    driver: {
  ...
  en: {
    ...
    auth: {
      ...
      logoutConfirm: "Do you want to logout? Session data will be cleared.",
    ...
    admin: {
      ...
      transactions: "Transactions", withdrawals: "Withdrawals", profile: "Profile",
      ...
      changeEmail: "Change Email", changePassword: "Change Password",
      darkMode: "Dark Mode", logoutWarning: "All session data will be cleared from device.",
    },
    driver: {
