...
const translations = {
  ar: {
    ...
    customer: {
      ...
      uploadStudentCert: "رفع شهادة مدرسية", uploadWorkCard: "رفع بطاقة العمل",
      uploadDisabilityCert: "رفع شهادة إعاقة", nationalId: "رقم التعريف الوطني",
  ...
  fr: {
    ...
    customer: {
      ...
      uploadStudentCert: "Certificat scolaire", uploadWorkCard: "Carte de travail",
      uploadDisabilityCert: "Certificat d'invalidité", nationalId: "N° identité nationale",
  ...
  en: {
    ...
    customer: {
      ...
      uploadStudentCert: "School Certificate", uploadWorkCard: "Work Card",
      uploadDisabilityCert: "Disability Certificate", nationalId: "National ID Number",
