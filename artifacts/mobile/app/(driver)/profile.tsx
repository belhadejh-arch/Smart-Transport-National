  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.role}>🚍 {t.admin.driver}</Text>
        ...
        <View style={styles.note}>
          <Text style={styles.noteText}>🔒 {t.customer.changePassword} — {t.admin.resetPassword}</Text>
        </View>

        <TouchableOpacity style={styles.switchBtn} onPress={switchAccount} activeOpacity={0.85}>
